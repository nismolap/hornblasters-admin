                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  Text('Add New\nPic / Video',textAlign: TextAlign.left,
                                    style: TextStyle(
                                        ...
                                        child: Form(
                                          ...
                                          child: Column(
                                            children: [
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          flex: 10,
                                                          child: TextFormField(
                                                            initialValue: controller.pagetype.value == 'add' ? null : '${controller.title.value}',
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Expanded(
                                                          flex: 10,
                                                          child: TextFormField(
                                                            initialValue: controller.pagetype.value == 'add' ? null : '${controller.url.value}',
                                              ...
                                              controller.pagetype.value == 'edit' ? Container(
